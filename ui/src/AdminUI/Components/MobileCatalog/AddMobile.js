...
function AddMobile(props) {
    let { isAddModalOpen, toggleAdd } = props;
    ...
    const addmobilecatalog = async (event) => {
        ...
        if (await validate()) {
            ...
            await actions.addMobileCatalog(mobileCatalogDispatch, data)
    ...
    const validate = () => {
        ...
        if (!mobile.imageFileName) {
            isValid = false;
            err["image"] = "Please uplaod image.";
        }
        else if (typeof mobile.imageFileName !== "undefined") {
            if (!mobile.imageFileName.name.match(/\.(jpg|jpeg|png)$/)) {
                isValid = false;
    ...
    return (
        <>
            <Modal isOpen={isAddModalOpen} toggle={toggleAdd} centered scrollable className="common-modal">
                <ModalHeader toggle={toggleAdd}>Add Phone</ModalHeader>
                <ModalBody>
                    <form>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="form-group row">
                                        <label className="col-form-label col-lg-3">Name <span className="text-danger">*</span></label>
                                    ...
                                    <div className="form-group row">
                                        <label className="col-form-label col-lg-3 d-flex">Manufacture <span className="text-danger">*</span></label>
                                        <div className="col-lg-9">
                                    ...
                                    <div className="form-group row">
                                        <label className="col-form-label col-lg-3 d-flex">Description <span className="text-danger">*</span></label>
                                        <div className="col-lg-9">
                                            <textarea rows="3" name="description" cols="3" className="form-control" placeholder="Enter Description" aria-invalid="true"
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-lg-9">
                                            ...
                                            />
                                            <div className="error">{validation["image"]}</div>
                                        </div>
                                    </div>
                                    <div className="form-group row">
                ...
                <ModalFooter>
                    <div className="d-flex align-items-center justify-content-between w-100">
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <Button type="submit" className="primary-btn" onClick={addmobilecatalog} >Add</Button>
                        </div>
                    </div>
                </ModalFooter>
            </Modal>
...
export default withRouter(AddMobile);
